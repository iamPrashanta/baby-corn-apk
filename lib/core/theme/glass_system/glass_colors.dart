// lib/core/theme/glass_system/glass_colors.dart
...
class GlassColors {
  ...
  static const Color lightGlassSurface =
      Color(0x99FFFFFF); // 60% white (milk glass)
  static const Color lightGlassBorder =
      Color(0x1AFFFFFF); // 10% white (soft edge)
  static const Color lightGlassGlow =
      Color(0x0A000000); // 4% black for very soft depth

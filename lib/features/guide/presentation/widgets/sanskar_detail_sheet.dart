// lib/features/guide/presentation/widgets/sanskar_detail_sheet.dart
...
class _SanskarDetailSheetState extends ConsumerState<SanskarDetailSheet> {
  ...
  Future<void> _pickDate() async {
    ...
    if (picked != null) {
      ...
      ref
          .read(sanskarsProvider.notifier)
          .updateCustomDate(widget.sanskar.id, picked);
    }
  }
  ...
  void _saveNotes() {
    ref
        .read(sanskarsProvider.notifier)
        .updateNotes(widget.sanskar.id, _notesController.text);
  ...
  Widget build(BuildContext context) {
    ...
    final sanskar = ref
        .watch(sanskarsProvider)
        .firstWhere((s) => s.id == widget.sanskar.id);
        ...
        children: [
              ...
              children: [
                ...
                if (sanskar.customDate != null) ...[
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                          'Revert to traditional (${sanskar.defaultRule.traditionalTimingText})',
                          style: const TextStyle(fontSize: 12)),
                      TextButton(
                        onPressed: () {
                          ref
                              .read(sanskarsProvider.notifier)
                              .updateCustomDate(sanskar.id, null);
                          setState(() => _currentDate = widget
                              .effectiveDate); // Revert local state to originally calculated
                        },
                        child:
          ...
          SwitchListTile(
            ...
            onChanged: (val) {
              ref
                  .read(sanskarsProvider.notifier)
                  .toggleReminder(sanskar.id, val);
            },
          ),
          const SizedBox(height: 24),
          const Text('Personal Notes / Memories',
              style: TextStyle(fontWeight: FontWeight.bold)),
          const SizedBox(height: 8),
          TextField(
            ...
            decoration: InputDecoration(
              hintText:
                  'Add family traditions, pandit details, or memories here...',
              filled: true,
              fillColor:
